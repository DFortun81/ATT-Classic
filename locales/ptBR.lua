...
L.ZONE_TEXT_TO_MAP_ID["Auchindoun: Catacumbas Auchenai"] = 256;	-- CRYPTS
L.ZONE_TEXT_TO_MAP_ID["Auchindoun: Tumbas de Mana"] = 272;	-- MT
L.ZONE_TEXT_TO_MAP_ID["Auchindoun: Salões dos Sethekk"] = 258;	-- SETH
L.ZONE_TEXT_TO_MAP_ID["Auchindoun: Labirinto Soturno"] = 260;	-- SLABS
L.ZONE_TEXT_TO_MAP_ID["Cavernas do Tempo: Lamaçal Negro"] = 273;	-- BLKM
L.ZONE_TEXT_TO_MAP_ID["Cavernas do Tempo: Antigo Contraforte de Eira dos Montes"] = 274;	-- OHF
...
L.ALT_ZONE_TEXT_TO_MAP_ID["Bastilha da Tormenta"] = 334;		-- TK
