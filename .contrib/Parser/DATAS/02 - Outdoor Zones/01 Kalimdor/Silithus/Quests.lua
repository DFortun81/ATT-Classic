	...
	m(KALIMDOR, {
		m(SILITHUS, {
			n(QUESTS, {
				...
				q(8780, {	-- Armor Kits for the Field
					["u"] = 3,	-- Added in later phase
					["lvl"] = 60,
					["g"] = {
				...
				q(8787, {	-- Armor Kits for the Field
					["u"] = 3,	-- Added in later phase
					["lvl"] = 60,
					["g"] = {
						i(20800),	-- Cenarion Logistics Badge
