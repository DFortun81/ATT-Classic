...
_.WorldEvents = bubbleDown({["u"] = PHASE_FIVE_SILITHYST }, 
{
	n(-541, {	-- The Silithyst Must Flow
		...
		["u"] = PHASE_FIVE_SILITHYST,
		["lvl"] = 60,
		["groups"] = {
			un(PHASE_FIVE_SILITHYST, q(9416, {	-- Report to General Kirika
				["qg"] = 17081,	-- Scout Bloodfist
				["coord"] = { 49.0, 36.7, SILITHUS },
				["races"] = HORDE_ONLY,
				["lvl"] = 53,
			})),
			un(PHASE_FIVE_SILITHYST, q(9415, {	-- Report to Marshal Bluewall
				["qg"] = 17082,	-- Rifleman Torrig
				["coord"] = { 50.7, 34.7, SILITHUS },
				["races"] = ALLIANCE_ONLY,
				["lvl"] = 53,
			})),
			un(PHASE_FIVE_SILITHYST, q(9419, {	-- Scouring the Desert [ALLIANCE]
			...
			un(PHASE_FIVE_SILITHYST, q(9422, {	-- Scouring the Desert [HORDE]
